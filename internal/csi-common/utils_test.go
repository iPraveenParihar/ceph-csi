...
func TestKillOnSlowGRPCStuckHandler(t *testing.T) {
	...
	go func() {
		//nolint:errcheck,gosec // return values intentionally ignored; only side-effect (osExit) is tested
...
func TestKillOnSlowGRPCReclaimSpaceExcluded(t *testing.T) {
	...
	for _, method := range []string{
		...
		go func() {
			...
			//nolint:errcheck,gosec // return values intentionally ignored; only side-effect (no osExit) is tested
